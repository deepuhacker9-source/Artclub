...
export default function Login() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-72 h-72 bg-pink-700 blur-3xl opacity-20 rounded-full animate-pulse"></div>
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-purple-600 blur-3xl opacity-20 rounded-full animate-pulse"></div>
