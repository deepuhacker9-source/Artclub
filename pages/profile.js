...
function ProfilePage() {
  ...
  // sync form when profile loads (prevents undefined field bugs)
  useEffect(() => {
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-xl overflow-hidden">
          ...
          <div className="h-40 bg-gradient-to-r from-pink-300 to-orange-300 relative">
            <div className="absolute -bottom-12 left-6">
              <img
                src={form.avatar_path || profile.raw_user_meta_data?.avatar_url}
                alt="avatar"
          ...
          <div className="pt-16 px-6 pb-6">
            ...
            <div className="mt-6 flex gap-4">
              <div>
                ...
                <p className="text-gray-700">{form.avg_rating}</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">Verified</h3>
                <p className="text-gray-700">
                  {form.verified ? "Yes" : "Not Verified"}
                </p>
              </div>
            </div>
            ...
            <p className="text-xs text-gray-500 mt-6">
              Joined: {new Date(form.created_at).toLocaleDateString()}
            </p>
