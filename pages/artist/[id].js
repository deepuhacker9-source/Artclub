        ...
        {artist && (
          <>
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold">{artist.name} {artist.verified && <span className="text-blue-500">✔</span>}</h2>
                ...
                <Link href="/request"><button className="mt-3 bg-pink-700 text-white px-4 py-2 rounded">Request from this artist</button></Link>
              </div>
            </div>
